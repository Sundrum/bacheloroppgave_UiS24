...
const renderInfoButton = () =>
{
    ...
    <img class="mt-1 mb-0 mr-2 btn-flag-active image-responsive" src="${icons.flagUK.src}">
    <img class="mt-1 mb-0 ml-2 btn-flag image-responsive" src="${icons.flagNorway.src}" onclick="window.location='demo_norway';">
