    ...
    <div class="col-12">
        @foreach ($users as $user)
            @if($user->user_id !== Auth::user()->user_id)
                <div id="object{{$user->user_id}}" onclick="rotateImg('arrow{{$user->user_id}}')" class="card-rounded bg-white p-3 mb-2" data-toggle="collapse" data-target="#collapseuser{{$user->user_id}}" aria-expanded="true" aria-controls="collapseuser">
