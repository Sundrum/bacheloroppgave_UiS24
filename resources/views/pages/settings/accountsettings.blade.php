...
<div class="row">
    <div class="col-12">
        <button class="btn btn-success card-rounded float-right" onclick="removeValues()" type="button" data-toggle="modal" data-target="#newUser">
...
<div id="userslist">
    ...
    <div class="col-12">
        @foreach ($users as $user)
            <div id="object{{$user->user_id}}" onclick="rotateImg('arrow{{$user->user_id}}')" class="row card card-rounded bg-light mt-4" data-toggle="collapse" data-target="#collapseuser{{$user->user_id}}" aria-expanded="true" aria-controls="collapseuser">
            ...
            <div id="collapseuser{{$user->user_id}}" class="collapse bg-light" aria-labelledby="headingOne" data-parent="#object{{$user->user_id}}">
                ...
                <div class="container mt-4">
                    @foreach($user->units as $unit)
                        <div class="row mt-1 mb-1 card card-rounded" id="access{{$unit->sensoraccess_id}}">
                            <div class="col-12">
                                <div class="row">
