...
<form action="{{ route('invoice') }}" method="POST">
    ...
    <button type="submit" value="{{$payment_id}}" id="downloadButton" class="btn-7g">
       Download PDF
    </button>
</form>
...
.bg-white.card-rounded table {
    width: 100%;
    border-collapse: collapse;
    margin-top: 20px;
}

.bg-white.card-rounded th,
.bg-white.card-rounded td {
