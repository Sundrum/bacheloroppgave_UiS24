...
<div class="row mb-3 no-print">
    <div class="col">
        <div class="row p-2">
            <div class="col">
                <a class="btn-7g" href="/admin/irrigationstatus" style="color: black; text-decoration: none;"><img class="" src="{{ asset('/img/back.svg') }}"> <strong>Tilbake til Irrigation Status</strong></a>
            </div>
        </div>
    </div>
</div>
