...
<div class="mt-3 mb-3">
    <div class="row">
        <div class="@if(isset($user))col-md-6 @else col-md-12 @endif card card-rounded">
            <h5 class="m-4 text-center">@lang('admin.userinfo')</h5>
                ...
                <form method="POST" name="userupdate" id="userupdate" action="{{route('updateUser')}}">
                    ...
                    <div class="row">
                        <div class="col text-end mt-2">
                            <button type="submit" id="userform" class="btn-7g"> @lang('admin.save') </button>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="col-md-12 mt-4 mb-4">
    ...
    <div class="row mb-4 justify-content-center">
        <div class="col text-center">
            <a class="btn-7g m-1" href="/select/{{$user->user_id}}/{{$user->customernumber}}">@lang('admin.loginas')</a>
            <a class="btn-7s m-1" href="/admin/customer/{{$user->customer_id_ref}}">@lang('admin.customer')</a>
            <a class="btn-7r m-1" href="#">@lang('admin.delete')</a>
        </div>
    </div>
</div>
